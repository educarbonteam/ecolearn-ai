...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://ecolearn:ecolearn2024@localhost:5432/ecolearn")
...
# 10. Secrets Manager
DB_URL="postgresql://ecolearn:PASSWORD@${RDS_ENDPOINT}:5432/ecolearn"
