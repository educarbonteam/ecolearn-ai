...
class CarbonService:
    ...
    def calculate_carbon_footprint(
        learning_hours: float, category: str = "default"
    ) -> Dict[str, Any]:
        """
        ...
        coefficient = CarbonService.CARBON_COEFFICIENTS.get(
            category, CarbonService.CARBON_COEFFICIENTS["default"]
        )
    ...
    async def plant_trees_via_api(
        user_id: int, trees_count: int, location: Optional[str] = None
    ) -> Dict[str, Any]:
        """
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 201:
                    ...
                    return {
                        ...
                        "carbon_offset_kg": trees_count
                        * CarbonService.TREE_CO2_ABSORPTION
                        / 365,
                    ...
                    return CarbonService._simulate_tree_planting(
                        user_id, trees_count, location
                    )
    ...
    def _simulate_tree_planting(
        user_id: int, trees_count: int, location: Optional[str]
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "carbon_offset_kg": round(
                trees_count * CarbonService.TREE_CO2_ABSORPTION / 365, 2
            ),
            "estimated_growth_years": 20,
    ...
    def calculate_platform_impact(
        total_users: int, total_learning_hours: float
    ) -> Dict[str, Any]:
        """
        ...
        avg_carbon = CarbonService.calculate_carbon_footprint(
            total_learning_hours, "default"
        )

        # Assume 20% of carbon is offset through tree planting
        trees_planted = int(
            avg_carbon["carbon_offset_kg"]
            * 0.2
            / CarbonService.TREE_CO2_ABSORPTION
            * 365
        )
        ...
        return {
            ...
            "average_per_user": {
                ...
                "carbon_kg": round(
                    avg_carbon["carbon_offset_kg"] / max(total_users, 1), 2
                ),
            },
        }
